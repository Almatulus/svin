 ...
 */
class StaffCreateForm extends Model
{
    public $name;
    public $surname;
    ...
    public $has_calendar = true;
    public $can_create_order = true;
    public $can_update_order = false;
    public $create_user = false;
    public $birth_date;
    public $username;
    public $see_customer_phones = false;
    public $code_1c;

    private $company_id;

    /**
     * StaffCreateForm constructor.
     * @param int $company_id
     * @param array $config
     */
    public function __construct(int $company_id, array $config = [])
    {
    ...
    {
        $this->user_divisions = Division::find()->company($this->company_id)->enabled()->column();
        ...
        return [
            ...
            [
                ...
                'filter' => function ($value) {
                    $division_service_ids = json_decode($value);
            ...
            ['user_divisions', 'each', 'rule' => ['integer']],
            [
                'user_divisions',
                'each',
                'rule' => ['exist', 'targetClass' => Division::class, 'targetAttribute' => 'id']
            ],
