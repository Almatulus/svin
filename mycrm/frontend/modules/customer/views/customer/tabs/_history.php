...
<div class="row">
    <div class="col-sm-6">
        <div class="info-box">
            <div class="box-title">Предстоящие записи: <?= count($orders_soon) ?></div>
            <?php if (count($orders_soon) == 0): ?>
                <h3>Нет прошедших записей</h3>
            <?php endif; ?>
            <?php foreach($orders_soon as $order): ?>
    ...
    <div class="col-sm-6">
        <div class="info-box">
            ...
            <?php if (count($orders_passed) == 0): ?>
                <h3>Нет прошедших записей</h3>
            <?php endif; ?>
            <?php foreach($orders_passed as $order): ?>
                <div class="box-rows lbl">
                    <div class="light row">
                        <div class="col-xs-6">
                            <div class="bigger overflow_with_ellipsis wrap-white-space">
