...
class CompanyUpdateForm extends Model
{
    ...
    public $show_referrer;
    public $show_new_interface;
    public $interval;
    public $unlimited_sms;
    public $notify_about_order;
    public $cashback_percent;
    public $limit_auth_time_by_schedule;
    ...
    {
        $this->setAttributes($company->attributes);
        $this->enable_web_call = $company->hasWebCallAccess();
