...
/* @var $model \core\forms\staff\StaffCreateForm */
...
<div class="staff-create">
    ...
    <div class="staff-form">
        ...
        <ol>
            ...
            <li class="control-group string staff_services" data-name="staff_service_ids">
                <label class="string control-label" for="staff_service_ids">Услуги</label>
                <div class="controls">
                    <div id="services_tree"></div>
                    <input id="staff_service_ids" name="Staff[division_service_ids]" type="hidden">
                </div>
            </li>
            ...
            <li class="skip_count">
                <ol class="inner-inputs-list">
                    ...
                    <li class="control-group string staff_user_permissions" style="display: none" data-name="staff_user_permissions">
                        <div class="controls">
                            <label class="string control-label" for="staff_user_permissions">Доступы</label>
                            <div class="controls">
                                <div id="permissions_tree"></div>
                                <input id="staff_user_permissions" name="Staff[user_permissions]" type="hidden">
                            </div>
                    ...
                    <li class="control-group boolean staff_can_create_order"
                        style="display: none">
            ...
            <li class="control-group select optional">
                <div class="controls">
                    <?= $form->field($model, 'company_position_ids')
                             ->widget(Select2::classname(), [
                                 'data'          => ArrayHelper::map(CompanyPosition::getOwnCompanyPositions(),
                                     'id', 'name'),
                                 'options'       => [
                                     'multiple' => true,
                                     'prompt' => Yii::t('app',
                                         'Select company positions'),
                                 ],
                                 'addon'         => [
                                     'append'       => [
        ...
        <?php
        $source_url     = \yii\helpers\Url::to(['/division/division/service']);
        $staff_id       = 0;
        $source         = Json::encode([]);
        $timetableTitle = Yii::t('app', 'Timetable');
        $permissions    = Json::encode(StaffHelper::getPermissionsTree());
