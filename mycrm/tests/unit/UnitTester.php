<?php //[STAMP] d76cc710d4d0233b4b6743249cc726e8
...
class UnitTester extends \Codeception\Actor
{
     ...
     * ``` php
     * <?php
     * $user_id = $I->haveRecord('core\models\user\User', array('name' => 'Davert'));
     * ?>
     * ```
     *
     * @param $model
     ...
     *
     * ``` php
     * $I->seeRecord('core\models\user\User', array('name' => 'davert'));
     * ```
     *
     * @param $model
     * @param array $attributes
     ...
     *
     * ``` php
     * $I->dontSeeRecord('core\models\user\User', array('name' => 'davert'));
     * ```
     *
     * @param $model
     * @param array $attributes
     ...
     *
     * ``` php
     * $category = $I->grabRecord('core\models\user\User', array('name' => 'davert'));
     * ```
     *
     * @param $model
     * @param array $attributes
